...
- (void)addObserver:(id)observer {
    if (!observers_) {
        ...
        observers_ = CFBridgingRelease(CFSetCreateMutable(NULL, 0, &(CFSetCallBacks){
...
- (void)forwardInvocationToObservers:(NSInvocation *)invocation {
    pendingObservers_ = CFBridgingRelease(CFSetCreateMutableCopy(NULL, 0, (__bridge CFTypeRef)observers_));
